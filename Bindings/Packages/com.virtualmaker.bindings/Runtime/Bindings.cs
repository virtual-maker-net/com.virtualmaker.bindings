...
namespace VirtualMaker.Bindings
{
    public static partial class Bindings
    {
        ...
        public static IReadOnlyDictionary<TItem, TComponent> BindList<TItem, TComponent>(
            ...
            => BindingsInternal.BindList(new(cancellationToken), parent, prefab, prop, onPrefabAdded, onListUpdated);
        ...
        public static IReadOnlyDictionary<TKey, TComponent> BindDictionary<TKey, TValue, TComponent>(
            ...
            => BindingsInternal.BindDictionary(new(cancellationToken), parent, prefab, prop, onPrefabAdded);
    }
}